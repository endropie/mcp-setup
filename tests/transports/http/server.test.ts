...
import { HttpTransport } from '../../../src/transports/http/server.js';
...
describe('HttpTransport', () => {
  ...
  describe('Constructor', () => {
    it('should initialize with default configuration', () => {
      ...
      expect(defaultTransport.type).toBe('http');
    });
    ...
    it('should initialize with custom configuration', () => {
      ...
      expect(customTransport.type).toBe('http');
    });
  });
  ...
  describe('Transport Management', () => {
    ...
    it('should throw when trying to start an already running transport', async () => {
      ...
      await expect(transport.start()).rejects.toThrow('HttpTransport already started');
    });
  });
  ...
  describe('Configuration Validation', () => {
    it('should handle different response modes', () => {
      const streamTransport = new HttpTransport({
        responseMode: 'stream',
      });
  ...
  describe('Error Handling', () => {
    it('should handle port conflicts gracefully', async () => {
      ...
      const transport1 = new HttpTransport({ port });
      const transport2 = new HttpTransport({ port });
    ...
    it('should handle configuration errors gracefully', () => {
      ...
      expect(invalidTransport.type).toBe('http');
    });
  });
